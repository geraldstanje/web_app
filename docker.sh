...
run() {
  ...
  docker run -p 5432:5432 -e POSTGRES_USER=admin -e POSTGRES_PASSWORD=asecurepassword --name postgresql_example_name -v "/var/lib/postgresql/data:/var/lib/postgresql/data" outyet
}
